      ...
      {loading ? null : (
        <div className="min-h-full">
          <div className="md:grid md:grid-cols-3 md:gap-6 h-full">
            <div className="mt-5 md:mt-0 md:col-span-3 h-full">
                  ...
                  <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                      ...
                      <div className="col-span-3 sm:col-span-3">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <input
                            type="text"
                            id="nameInput"
                            className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300 pl-2"
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Brief description for your subject. URLs are
                        hyperlinked. Maximum 96 characters allowed.
                      </p>
                    </div>
                    {/* <div>
